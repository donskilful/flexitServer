...
const welcomeEmailTemplate = () => `<head>
...
<div
  ...
  "
>
  Welcome to TWITEE We're thrilled to have you here! Get ready to dive into your new account.
</div>
    ...
    <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
      ...
      >
        <tr>
          ...
          >
            <p style="margin: 0">
              We're excited to have you get started. First, we are glad to see you here, thanks for choosing TWITEE.
            </p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td
            ...
            "
          >
            <p style="margin: 0">Cheers,<br />Twitee</p>
          </td>
        </tr>
      </table>
    </td>
